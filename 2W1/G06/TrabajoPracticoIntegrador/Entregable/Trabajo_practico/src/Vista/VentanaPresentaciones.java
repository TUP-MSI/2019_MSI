...
public class VentanaPresentaciones extends javax.swing.JFrame {
    ...
    public VentanaPresentaciones() {
        ...
        v.validarSoloNumeros(txtDuracion);
        v.validarSoloNumeros(txtHoraInicio);
        v.limitarCaracteres(txtHoraInicio, 5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaPresentaciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
